...
@section('content')
  ...
  <div class="card">
    <div class="card-body">
      ...
      <form class="forms-sample" action="{{ url('/movie/update' , $edit_movies->movie_id) }}" method="POST" enctype="multipart/form-data">
      	{{ csrf_field() }}
        <div class="form-group">
          <label>Movie Name</label>
          <input type="text" class="form-control" name="movie_name" value="{{ $edit_movies->movie_name }}">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="movie_length" value="{{ $edit_movies->movie_length }}">
        </div>
